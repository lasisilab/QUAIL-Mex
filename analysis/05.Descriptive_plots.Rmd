...
1. Missing data overview: stacked bar chart showing complete, missing, and
   sentinel-flagged values for all analytic variables

2. HWISE total score (0–36) and PSS-14 total score (0–56) distributions
   stratified by season (histograms)

3. PSS-14 and water worry subscale distributions across HWISE categories
   (Marginal 0–2, Low 3–11, Moderate 12–23, High ≥24) — boxplots with
   annotated sample sizes

4. Objective water supply characteristics by neighborhood water security status
   (water-secure vs. water-insecure): hours per week, supply continuity, and
   supply frequency (histograms and bar charts)

5. Scatter plots of hours of water supply per week against HWISE total score
   and PSS-14 total score, with linear regression lines (±95% CI)
