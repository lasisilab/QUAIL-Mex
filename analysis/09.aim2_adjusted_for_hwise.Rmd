...
| Augmenting (one per model) | Hours of water supply/week · Intermittent supply · Season · Neighborhood comparison · Excessive time handling water · Sufficiency rating · Water pressure · Supply frequency · Neighborhood (WS/WI) · Years in neighborhood |
...
term_labels <- c(
  ...
  W_TrustNo                      = "Tap water trust: No (ref: Yes)",
  W_Garrafon_brandYes            = "Uses brand-name garraf\u00f3n: Yes (ref: No)",
  W_Has_tinacoYes                = "Has tinaco: Yes (ref: No)",
  W_Has_cisternaYes              = "Has cisterna: Yes (ref: No)",
  W_Bill_waivedYes               = "Water bill waived: Yes (ref: No)",
...
model_specs_pss <- list(
  ...
  m_a19 = list(
    ...
    formula = PSS_TOTAL ~ D_AGE + SES_SC_Total + D_HH_SIZE + Chronic_dis + HW_TOTAL + W_Trust
  ),
  m_a20 = list(
    label   = "a20",
    group   = "m_a20: Water infrastructure",
    formula = PSS_TOTAL ~ D_AGE + SES_SC_Total + D_HH_SIZE + Chronic_dis + HW_TOTAL + W_Garrafon_brand
  ),
  m_a21 = list(
    label   = "a21",
    group   = "m_a21: Water infrastructure",
    formula = PSS_TOTAL ~ D_AGE + SES_SC_Total + D_HH_SIZE + Chronic_dis + HW_TOTAL + W_Has_tinaco
  ),
  m_a22 = list(
    label   = "a22",
    group   = "m_a22: Water infrastructure",
    formula = PSS_TOTAL ~ D_AGE + SES_SC_Total + D_HH_SIZE + Chronic_dis + HW_TOTAL + W_Has_cisterna
  ),
  m_a23 = list(
    label   = "a23",
    group   = "m_a23: Water infrastructure",
    formula = PSS_TOTAL ~ D_AGE + SES_SC_Total + D_HH_SIZE + Chronic_dis + HW_TOTAL + W_Bill_waived
  ),
  m_a24 = list(
    label   = "a24",
    group   = "m_a24: Water infrastructure",
    formula = PSS_TOTAL ~ D_AGE + SES_SC_Total + D_HH_SIZE + Chronic_dis + HW_TOTAL + W_Cost_2mnths
  )
)
...
b_pc_p <- which(!is.na(top_pss$p_coef_num) & top_pss$p_coef_num < 0.05)
b_pa_p <- which(!is.na(top_pss$p_adj_num)  & top_pss$p_adj_num  < 0.05)
...
fp_order_pss <- c(
  ...
  "Years in neighborhood"                               = 14,
  "Tap water trust: No (ref: Yes)"                       = 15,
  "Uses brand-name garraf\u00f3n: Yes (ref: No)"          = 16,
  "Has tinaco: Yes (ref: No)"                            = 17,
  "Has cisterna: Yes (ref: No)"                          = 18,
  "Water bill waived: Yes (ref: No)"                     = 19,
  "Bimonthly water cost (pesos)"                         = 20
)
...
coefs_pss <- summary_pss %>%
  mutate(
    ...
    panel_group = factor(panel_group, levels = c("Supply frequency", "Water supply")),
    sig         = sig_sym(p.value),
    fp_order    = coalesce(fp_order_pss[term_label], as.double(estimate) + 100)
  ) %>%
...
model_specs_emo <- list(
  ...
  m_b19 = list(
    ...
    formula = EMO_NEG ~ D_AGE + SES_SC_Total + D_HH_SIZE + PSS_TOTAL + Chronic_dis + HW_TOTAL + W_Trust
  ),
  m_b20 = list(
    label   = "b20",
    group   = "m_b20: Water infrastructure",
    formula = EMO_NEG ~ D_AGE + SES_SC_Total + D_HH_SIZE + PSS_TOTAL + Chronic_dis + HW_TOTAL + W_Garrafon_brand
  ),
  m_b21 = list(
    label   = "b21",
    group   = "m_b21: Water infrastructure",
    formula = EMO_NEG ~ D_AGE + SES_SC_Total + D_HH_SIZE + PSS_TOTAL + Chronic_dis + HW_TOTAL + W_Has_tinaco
  ),
  m_b22 = list(
    label   = "b22",
    group   = "m_b22: Water infrastructure",
    formula = EMO_NEG ~ D_AGE + SES_SC_Total + D_HH_SIZE + PSS_TOTAL + Chronic_dis + HW_TOTAL + W_Has_cisterna
  ),
  m_b23 = list(
    label   = "b23",
    group   = "m_b23: Water infrastructure",
    formula = EMO_NEG ~ D_AGE + SES_SC_Total + D_HH_SIZE + PSS_TOTAL + Chronic_dis + HW_TOTAL + W_Bill_waived
  ),
  m_b24 = list(
    label   = "b24",
    group   = "m_b24: Water infrastructure",
    formula = EMO_NEG ~ D_AGE + SES_SC_Total + D_HH_SIZE + PSS_TOTAL + Chronic_dis + HW_TOTAL + W_Cost_2mnths
  )
)
...
b_pc_ep <- which(!is.na(top_emo$p_coef_num) & top_emo$p_coef_num < 0.05)
b_pa_ep <- which(!is.na(top_emo$p_adj_num)  & top_emo$p_adj_num  < 0.05)
...
coefs_emo <- summary_emo %>%
  mutate(
    ...
    panel_group = factor(panel_group, levels = c("Supply frequency", "Water supply")),
    sig         = sig_sym(p.value),
    fp_order    = coalesce(fp_order_emo[term_label], as.double(estimate) + 100)
  ) %>%
  arrange(panel_group, fp_order)
