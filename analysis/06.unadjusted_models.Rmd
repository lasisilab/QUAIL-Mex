...
group_map <- c(
  ...
  NB_COMP = "Water supply", TIME_WATER = "Water supply",
  SUFF_RATING = "Water supply",
...
predictor_order <- c(
  ...
  NB_COMP = 8, TIME_WATER = 9, SUFF_RATING = 10,
...
pred_labels <- c(
  ...
  NB_COMP          = "Neighborhood water quality vs. own",
  TIME_WATER       = "Excessive time in water management",
  SUFF_RATING      = "Water sufficiency rating (1\u20134)"
)
