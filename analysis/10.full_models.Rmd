...
> (`WI_NEIGHBORHOOD`, `SEASON`) are recreated using Aim 2 variable prep
> (SEASON is already prepared above; W_WS_LOC_F serves as the Aim 2 equivalent).
