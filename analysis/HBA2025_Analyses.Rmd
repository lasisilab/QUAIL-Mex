...
ggplot(data, aes(x = HW_TOTAL_category, 
  ...
  theme_minimal() +
  labs(title = "HRS_WEEK by HWISE Category",
       x = "HWISE", 
...
ggplot(data, aes(x = MX28_WQ_COMP_category, 
  ...
  geom_boxplot(outlier.shape = 1, alpha = 0.5, 
      ...
      geom_text(data = means, 
             ...
             size = 3, color = "darkred") + #adds average labels
  theme_minimal() +
  labs(title = "HRS_WEEK by Group considering their water supply as worse, same or better than in other parts of the city",
       x = "", 
       y = "Hours of Water Supply per Week") +
  scale_fill_manual(values = color_palette) +  # Custom colors for boxes
  scale_color_manual(values = color_palette) +  # Custom colors for points +
  ...
  geom_boxplot(outlier.shape = 1, alpha = 0.3, 
    ...
    geom_text(data = means, 
      ...
      geom_text(data = summary_stats, 
              ...
              size = 4, fontface = "bold") +    # Add SD text annotations above the boxes
  theme_minimal() +
  labs(title = "HWISE score by Group considering their water supply as worse, same or better than in other parts of the city",
       x = "", 
       y = "HWISE score") +
  scale_fill_manual(values = color_palette) +  # Custom colors for boxes
  scale_color_manual(values = color_palette) +  # Custom colors for points +
...
ggplot(data_long, aes(x = as.factor(Response), y = HRS_WEEK, fill = as.factor(Response))) +
  ...
  theme_minimal() +
  labs(title = "Distribution of HRS_WEEK by total HWISE score",
       x = "HWISE score", 
       y = "Hours of Water Supply per Week") +
 # scale_fill_manual(values = color_palette) +  # Custom colors for boxes
 # scale_color_manual(values = color_palette) +  # Custom colors for points
...
ggplot(data_long, aes(x = as.factor(Response), y = HRS_WEEK, fill = as.factor(Response))) +
  ...
  theme_minimal() +
  labs(title = "Distribution of HRS_WEEK by HW_ Questions",
       x = "Response", 
       y = "Hours of Water Supply per Week") +
#  scale_fill_manual(values = color_palette) +  # Custom colors for boxes
#  scale_color_manual(values = color_palette) +  # Custom colors for points
