---
title: "08. Univariable Regression Models"
author: ""
date: "`r Sys.Date()`"
output:
  html_document:
...
# Univariable Models: PSS Total Score (linear)
...
# Univariable Models: Emotion Type (logistic)
...
save_as_docx(pss_ft, path = file.path(output_dir, "07.TableUV1_uvreg_PSS.docx"))
save_as_docx(emo_ft, path = file.path(output_dir, "07.TableUV2_uvreg_EmoType.docx"))

cat("Exported:\n",
    " -", file.path(output_dir, "07.TableUV1_uvreg_PSS.docx"), "\n",
    " -", file.path(output_dir, "07.TableUV2_uvreg_EmoType.docx"), "\n")
```
