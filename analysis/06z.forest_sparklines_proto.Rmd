...
group_map <- c(
  ...
  W_Continuity = "Supply frequency", W_Frequency = "Supply frequency",
  W_Days_week = "Supply frequency", W_Hrs_week = "Supply frequency",
  Season = "Water supply", W_WS_LOC_F = "Water supply",
  W_Pressure = "Water supply",
  W_Trust = "Water supply", W_Garrafon_brand = "Water supply",
  W_Has_tinaco = "Water supply", W_Has_cisterna = "Water supply",
  W_Bill_waived = "Water supply", W_Cost_2mnths = "Water supply",
  NB_COMP = "Water supply", TIME_WATER = "Water supply",
  SUFF_RATING = "Water supply"
)

group_order <- c("Demographics", "Socioeconomic", "Health",
                 "HWISE", "Supply frequency", "Water supply")
...
predictor_order <- c(
  ...
  W_Continuity = 1, W_Frequency = 2, W_Days_week = 3, W_Hrs_week = 4,
  Season = 1, W_WS_LOC_F = 2, W_Pressure = 3,
  W_Trust = 4, W_Garrafon_brand = 5, W_Has_tinaco = 6, W_Has_cisterna = 7,
  W_Bill_waived = 8, W_Cost_2mnths = 9,
  NB_COMP = 10, TIME_WATER = 11, SUFF_RATING = 12
)
...
pred_labels <- c(
  ...
  Water_5sub      = "HWISE 5-items (0-15)",
  HWISE_Hi        = "HWISE binary",
  Water_worry     = "Water worry 3-items (0-9)",
  W_WS_LOC_F       = "Neighborhood",
  W_Continuity     = "",
  W_Frequency      = "",
  W_Days_week      = "Days/week",
  W_Hrs_week       = "Hours/week",
  ...
  W_Cost_2mnths    = "Bimonthly water cost (MX pesos)",
...
## Forest plot with sparklines — Emotion

```{r forest-sparklines-emo, fig.width=10.5, fig.height=11}
...
```{r save-emo, include=FALSE}
ggsave(
  "./output/figures/06z.Unadj_OR_EMO_sparklines.png",
  plot   = p_emo_spark,
  width  = 10.5, height = 11, dpi = 300, bg = "white"
)
cat("Saved: ./output/figures/06z.Unadj_OR_EMO_sparklines.png\n")
```
