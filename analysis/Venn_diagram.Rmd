...
png(file= "venn_diagram.png", width = 500, height = 500)

plot(venn_diagram, 
     fills = c("gold", "turquoise3", "coral1", "thistle"), 
     edges = list(col = "white", lex = 1.5),
     labels = list(size = 0.3, fontfamily = "RobotoCondensed-Semibold", fontsize = 15.5), 
     quantities = list(type = "percent", fontsize = 12.5))
