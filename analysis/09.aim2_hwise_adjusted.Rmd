...
in the same model. Only water supply characteristic models (m_a6–m_a18 /
m_b6–m_b18) are run here, each augmented with `HW_TOTAL` as an additional
core covariate.
...
p_pss
ggsave("./output/figures/09.aim2_hwise_pss_forest.png", p_pss,
       width = 10, height = 8, dpi = 300, bg = "white")
cat("Saved: ./output/figures/09.aim2_hwise_pss_forest.png\n")
```
...
p_emo
ggsave("./output/figures/09.aim2_hwise_emo_forest.png", p_emo,
       width = 10, height = 8, dpi = 300, bg = "white")
cat("Saved: ./output/figures/09.aim2_hwise_emo_forest.png\n")
```
