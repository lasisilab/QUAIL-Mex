...
q16s <- q16[,c("Folio", "X1.day.week..6.to.12", "X3.days.week", "X5.days.week", "Evaluación de su servicio de agua")] 
 ...
 temp <- q16s[is.na(q16s$participant == "Otro"), ] 
...
factor_levels <- c("Insuficiente","Moderadamente suficiente","Casi suficiente", "Completamente suficiente","Otro")
colnames(q16s)
...
png(file= "Q16_likert_plot_rm_participants.png", width = 1300, height = 600)
plot(likert(sur3), 
         centered = TRUE,
         center = 3.5,
         wrap = 15,
